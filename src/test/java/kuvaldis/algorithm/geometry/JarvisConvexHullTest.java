...
public class JarvisConvexHullTest {
    ...
    public void testThreePoints() throws Exception {
        // given
        final JarvisConvexHull hull = new JarvisConvexHull(new Point(3, 4), new Point(2, 1), new Point(5, 2));
    ...
    public void testFourPoints() throws Exception {
        // given
        final JarvisConvexHull hull = new JarvisConvexHull(new Point(3, 4),
    ...
    public void testComplex() throws Exception {
        ...
        // when
        final List<Point> result = new JarvisConvexHull(p).build();
    ...
    public void testSquare() throws Exception {
        // given
        final JarvisConvexHull hull = new JarvisConvexHull(new Point(0, 0),
